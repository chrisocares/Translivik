 ...
 */
public class Cambiar_pass extends Activity{
        ...
        btncambiar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(actual.trim().equals("")&&nueva.trim().equals("")&&nuevac.trim().equals("")){
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Cambiar_pass.this);
                    ...
                    if(contraseñaactual.equals(txtactual.getText().toString())&&txtnueva.getText().toString().equals(txtcnueva.getText().toString())){
                        ...
                        alertDialogBuilder.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                Intent intent = new Intent(Cambiar_pass.this, MainActivity.class);
    ...
    private String changepass(String variable,String variable2){
        ...
        HttpGet del =
                new HttpGet(ipconfig+"/SGSTTSERVICES/service/user/changepass/"+variable+"/in/"+variable2);
    ...
    private String getcontraseñaactual(String variable){
        ...
        HttpClient httpClient = new DefaultHttpClient();
        HttpGet del =
                new HttpGet(ipconfig+"/SGSTTSERVICES/service/user/getpass/"+variable);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            Intent intent = new Intent(Cambiar_pass.this, Menu.class);
            b=new Bundle();
            bsede=new Bundle();
