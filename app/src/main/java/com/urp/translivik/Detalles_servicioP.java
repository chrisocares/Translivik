 ...
 */
public class Detalles_servicioP extends Activity {
    private Bundle bid,b,buser;
    private TextView txtid,txtfecha,txtservicio,txttiposervicio,bb,bb2,txtfile,txtpax,txtpasajeros,txttrasladista,txtvuelo,txtestado,txtexterno,
            txtvehiculo,txtchofer,txtcostod,Intentatras;
    String get;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getvehiculo(getidvehiculo(id)).equals("null null")){
            txtvehiculo.setText("NO ASIGNADO");
            ibvehiculo.setEnabled(false);
        }else{
        ...
        ibcosto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Detalles_servicioP.this);
                ...
                alertDialogBuilder.setNegativeButton("Modificar", new DialogInterface.OnClickListener() {

                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent=new Intent(Detalles_servicioP.this,ModificarCotizacion.class);
                        b=new Bundle();
                        b.putString("idservicio", txtid.getText().toString());
                        intent.putExtras(b);
        ...
        ibvehiculo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Detalles_servicioP.this,Detalles_vehiculoP.class);
                b=new Bundle();
                bid=new Bundle();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
                Intent intent = new Intent(this, Adminserviciospendientes.class);
            b=new Bundle();
            buser=new Bundle();
    ...
    private String getfecha(String variable){

        HttpClient httpClient = new DefaultHttpClient();
        HttpGet del =
                new HttpGet(ipconfig+"/SGSTTSERVICES/service/user/HoraFecha/"+variable);
    ...
    private String getnombrepax(String variable){

        HttpClient httpClient = new DefaultHttpClient();
        HttpGet del =
                new HttpGet(ipconfig+"/SGSTTSERVICES/service/user/Nombrepax/"+variable);
